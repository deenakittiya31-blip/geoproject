...
const TabNavbar = () => {
    return (
        <div className='hidden h-full lg:flex items-center gap-5 font-semibold text-[15px] text-headingColor'>
            {/* Home Tab */}
            <div className='group relative h-full flex items-center'>
                ...
                <ul className='hidden absolute top-12 bg-white z-60 w-50 p-3 border border-gray-100 shadow rounded-lg group-hover:block'>
                    {
                        homeLink.map((i, idx) => (
            ...
            <div className='group relative h-full flex items-center'>
                ...
                <ul className='hidden absolute top-12 bg-white z-60 w-60 p-3 border border-gray-100 shadow rounded-lg group-hover:block'>
                    <li className='group/hotel relative border-b py-3 border-gray-200'>
                        ...
                        <ul className='hidden group-hover/hotel:block absolute top-0 left-full bg-white z-51 w-60 p-3 border border-gray-100 shadow rounded-lg '>
                            <li className='border-b py-3 border-gray-200'>
                    ...
                    <li className='group/flight relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>
                    ...
                    <li className='group/rental relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>
                    ...
                    <li className='group/car relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>
                    ...
                    <li className='group/destination relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>
            ...
            <div className='group relative h-full flex items-center'>
                ...
                <ul className='hidden absolute top-12 bg-white z-50 w-60 p-3 border border-gray-100 shadow rounded-lg group-hover:block'>
                    <li className='group/blog relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>
                    ...
                    <li className='group/auth relative border-b py-3 border-gray-200'>
                        <div className='flex justify-between items-center pr-3'>

...
const Subscripe = () => {
    return (
        <div className='bg-[url(https://geotrip-shreethemes.netlify.app/assets/bg-CnfkaFPo.jpg)] bg-cover bg-center bg-no-repeat h-[500px] w-full font-jost'>
            <div className='bg-[#020d16]/50 w-full h-full flex flex-col justify-center items-center'>
                <div className='font-bold text-center text-white text-2xl  md:text-[32px] mb-10'>
                    <h1>Subscribe & Get<br />Special Discount with GeoTrip.com</h1>
                </div>
                <form className='flex flex-col bg-white w-sm md:w-2xl rounded-md p-3'>
